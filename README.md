...
| `v0.2.0`        | Design system (tokens, TerminalPanel, VaultCard, scanlines) + i18n | Phase 1 |
| `v0.3.0`        | Target slot selection + safe backup + prepared export              | Phase 1 |
| `v0.4.0`        | Guided iPhone (Finder) transfer + local history (macOS MVP)        | Phase 1 | <-- we are here |
